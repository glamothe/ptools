...
class install_legacy_f2c(Command):

    description = "download and build legacy libf2c from ptools_dep repository."
...
def setup_package():
    ...
    setup(ext_modules=[ptools, cgopt],
          cmdclass={'build_ext': build_ext,
                    'install_legacy_f2c': install_legacy_f2c},
          packages=['.'],
          name='ptools',
          version='1.2')
