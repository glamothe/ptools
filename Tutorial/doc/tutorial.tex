...
\begin{verbatim}
apt-get install scons g++ f2c libboost-dev python-dev cython 
\end{verbatim}
%
...
From the PTools main directory ({\tt \$HOME/soft/ptools-XX}), type:

\begin{verbatim}
python setup.py build
\end{verbatim}

Now (until a better solution is found and documented) you need to create the following symbolic links:
