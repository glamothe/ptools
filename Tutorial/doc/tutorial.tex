...
\\%
Note: some ubuntu systems have an old version of gccxml that doesn't work well for binding this
library. If your version of gccxml is less than 0.9, you should consider installing gccxml manually (see \ref{gccxml})
