...
\begin{itemize}
\item The force\_field name can be chosen among attract1, attract2 or scorpion.
...
\begin{verbatim}
attract.py -ff force_field -r receptor.red -l ligand.red --ref=ligand.red -s > single.att
\end{verbatim}
...
\begin{verbatim}
attract.py -ff force_field -r receptor.red -l ligand.red --ref=ligand.red > docking.att &
\end{verbatim}
...
\begin{verbatim}
attract.py -ff attract1 -r receptor.red -l ligand.red --ref=ligand.red -s > single.att
\end{verbatim}
...
\begin{verbatim}
attract.py -ff attract1 -r receptor.red -l ligand.red --ref=ligand.red > docking.att &
\end{verbatim}
...
\section{Modelling proteins filaments}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Miscellaneous, tips and tricks}
