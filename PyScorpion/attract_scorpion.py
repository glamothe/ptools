...
# scorpion.par
checkFile("scorpion.par", "forcefield file is required.")
...
for trans in translations:
    ...
    for rot in rotations:
        ...
        for minim in minimlist:
            ...
            forcefield=ScorpionForceField("scorpion.par",surreal(cutoff))
            ...
            lbfgs_minimizer=ScorpionLbfgs(forcefield)
...
if ( not options.single and printFiles==True): 
    ...
    print compress_file("scorpion.par")
