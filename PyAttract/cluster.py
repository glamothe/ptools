...
if (__name__=="__main__"):
    ...
    parser.add_option("-e", "--energy_cutoff", action="store", type="float", dest="energy_cutoff", help="Energy cutoff value (default=1000.0)", default=1000.0)
    ...
    thecluster = cluster(lig,structures, options.nclusters, options.cluster_memory , options.rmsd_cutoff, options.energy_cutoff)
